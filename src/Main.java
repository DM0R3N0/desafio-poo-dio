...
public class Main {
    public static void main(String[] args) {
        ...
        curso1.setDescricao("descriçãoo curso java");
        curso1.setCargaHoraria(8);

        Curso curso2 = new Curso();
        curso2.setTitulo("curso js");
        curso2.setDescricao("descriçãoo curso js");
        ...
        System.out.println("Conteúdos Inscritos Simone:" + devSimone.getConteudosInscritos());
        devSimone.progredir();
        devSimone.progredir();
        devSimone.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Simone:" + devSimone.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Simone:" + devSimone.getConteudosConcluidos());
